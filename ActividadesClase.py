# -*- coding: utf-8 -*-
"""Copia de SP13 Python.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1OfUQJAvxS74xoQafG3jDisNWik-aPfED
...
if  Vel1 >= Vel2: #Se comprueba si las velocidades estan bien
  sys.exit("La Moto dos nunca va a alcanzar a la primera")
...
if Dis <= 0:  #Se comprueba si la distancia es correcta
  sys.exit("La Moto dos ua ha alcanzado a la primera")
